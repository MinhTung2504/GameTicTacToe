...
public class Java_tic_tac_toe extends JFrame {

    
     // Creates new form Java_tic_tac_toe
    
    public Java_tic_tac_toe(String name) {
    	super(name);
        initComponents();
        addAction();
    }
    ...
    public void winEffect(JButton b1, JButton b2, JButton b3)
    {
        ...
        JOptionPane.showMessageDialog(null, msg, "Notice", JOptionPane.YES_OPTION);
        reset();
